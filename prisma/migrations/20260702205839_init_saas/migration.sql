...
CREATE TABLE "organization_feature" (
    ...
    CONSTRAINT "organization_feature_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "organization_feature_organizationId_key" ON "organization_feature"("organizationId");
...
-- AddForeignKey
ALTER TABLE "organization_feature" ADD CONSTRAINT "organization_feature_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
